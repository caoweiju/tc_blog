...
所以还是考虑使用官方给的安装包比较靠谱[A shadowsocks client for Android](https://github.com/shadowsocks/shadowsocks-android)；点击进入[releases页面](https://github.com/shadowsocks/shadowsocks-android/releases)，选择自己的安卓apk包即可；
